...
# т.к. в задании не сказано каки должны быть аргументы то не стал тратить время на создани фильтров по отсечению всего вся...
# а пошел далеть другие задания )
# не делал передачу аргументов через список т.к. в задании сказано что
# функция принимает 3 аргумента,
# в 17:29 21.12.2020 задал вопрос куратору допустимо ли это, ответил что допустимо;).
